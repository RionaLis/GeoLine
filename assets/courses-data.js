...
window.COURSES_DATA = {
  ...
  "geodetic-astronomy": {
    ...
    topics: [
      ...
      { title: "Тема 04. Сферическая геодезия", lessons: [["celestial-sphere.html", "Небесная сфера и системы координат"], ["coord-time-links.html", "Связи систем координат и времени"], ["time-systems.html", "Системы измерения времени в астрономии"], ["time-systems-practice.html", "Практикум по системам времени"], ["reduction-calculations.html", "Редукционные вычисления в астрономии"]] },
