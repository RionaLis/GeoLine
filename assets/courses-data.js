...
window.COURSES_DATA = {
  "geodesy-course-1": {
    ...
    topics: [
      ...
      { title: "Тема 02. Геодезическое оборудование", lessons: [["modern-geodetic-instruments.html", "Современные геодезические приборы"], ["gnss-equipment.html", "ГНСС-оборудование: принцип работы"], ["distance-measurement.html", "Измерение расстояний"], ["measuring-tape.html", "Измерение расстояний рулеткой"], ["stadia-rangefinder.html", "Нитяный дальномер"], ["theodolites-classification-and-design.html", "Теодолиты: классификация, устройство и принцип работы"], ["theodolite-checks.html", "Теодолиты: поверки и юстировки"], ["theodolite-horizontal-angles.html", "Измерение горизонтальных углов теодолитом"], ["theodolite-vertical-angles.html", "Измерение вертикальных углов теодолитом"], ["levels-classification-and-design.html", "Нивелиры: классификация, устройство и принцип работы"], ["level-checks-and-adjustments.html", "Нивелиры: поверки и юстировки"]] },
  ...
  "geodetic-astronomy": {
    ...
    topics: [
      ...
      { title: "Тема 04. Сферическая геодезия", lessons: [["celestial-sphere.html", "Небесная сфера и системы координат"], ["coord-time-links.html", "Связи систем координат и времени"], ["time-systems.html", "Системы измерения времени в астрономии"]] },
      { title: "Тема 05. Приборы для астрономо-геодезических измерений", lessons: [] },
